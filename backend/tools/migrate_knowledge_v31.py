...
ATOMIC_SPLITS: dict[str, list[dict[str, Any]]] = {
    ...
    "contract.receive": [
        {"suffix": "preparation", "title": "Подготовка договора продавцом", "facts": [0, 2], "terms": ["кто готовит договор", "соглашение о переходе права", "реквизиты"]},
    ...
    "refund.application": [
        {"suffix": "one_time", "title": "Возврат Разового тарифа", "facts": [0, 1, 5, 6], "terms": ["возврат разового тарифа", "кнопка возврата", "история списаний", "кратно 5000"]},
