...
Источник: `reports\routing-v3-closed-control-270.json`.
Размечено: **55 из 55** провалов.
...
|---|---|---|---|---|---|
| `widget-001` | `onboarding` | `wrong_clarify` | `buyer.get_started` | `<clarification>` | да |
...
| `widget-008` | `onboarding` | `rerank_wrong` | `auction.formats / buyer.get_started` | `support.contact` | да |
| `widget-009` | `onboarding` | `wrong_clarify` | `buyer.get_started` | `<clarification>` | нет |
...
| `widget-028` | `bidding` | `rerank_wrong` | `auction.status` | `transfer.not_confirmed` | да |
...
| `widget-043` | `search_images` | `rerank_wrong` | `technical.lot_image_missing / lot.card_information` | `lot.definition` | да |
| `widget-045` | `search_images` | `rerank_wrong` | `lot.catalog_search` | `auction.completed_analytics` | да |
| `widget-047` | `search_images` | `wrong_clarify` | `technical.catalog_search_filter / lot.catalog_search` | `<clarification>` | да |
...
| `widget-068` | `transfer_docs` | `rerank_wrong` | `transfer.seller_no_response` | `transfer.not_confirmed` | да |
| `widget-070` | `transfer_docs` | `retrieval_miss` | `pickup.representative` | `pickup.receive_lot` | нет |
| `widget-072` | `transfer_docs` | `rerank_wrong` | `contract.receive` | `documents.preparation_delay` | да |
